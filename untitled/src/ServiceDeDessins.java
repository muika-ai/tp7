 ...
 */
    public class ServiceDeDessins {
         ...
         * @param longueur le nombre d'affichages du caractère (longueur >=0)
         */
         ...
         *
         * @param largeur largeur du rectangle (largeur >=0)
         * @param hauteur hauteur du rectangle (hauteur >=0)
         */
         ...
         *
         * @param côté côté du carré (largeur >=0)
         */
         ...
         * gauche.
         *
         * @param hauteur la hauteur du triangle (hauteur >=0)
         */
         ...
         *
         * @param demiHauteur la hauteur de chacun des triangles (hauteur >=0)
         */
         ...
         *
         * @param hauteur la hauteur (totale) du losange (hauteur>=0 et hauteur impaire)
         */
         ...
         *
         * @param largeur largeur du damier (largeur paire et >=0)
         * @param hauteur hauteur du damier (hauteur paire et >=0)
         */
         ...
         *
         * @param hauteur la hauteur (totale) de la croix (hauteur >=0 et hauteur
         *                impaire)
         */
         ...
         * Affiche un sapin
         *
         * @param nombreÉtages          Le nombre d'étages (nombreÉtages >= 0)
         * @param hauteurÉtageSupérieur La hauteur de l'étage supérieur (hauteurÉtageSupérieur >= 1)
         */
        public static void afficherSapin(int nombreÉtages, int hauteurÉtageSupérieur) {
            if (nombreÉtages < 0 || hauteurÉtageSupérieur < 1) {
                System.out
                        .println("ERREUR! afficherSapin : paramètre incorrect");
            } else {
